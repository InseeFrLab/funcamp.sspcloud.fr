        ...
        <div className="Home">
            ...
            <section className="scheme">
                ...
                <div>
                    ...
                    <button
                        onClick={useCallback(() => window.open("https://funcamp-funcamp.gitbook.io/demarrage_rapide"), [])}
            ...
            <section className="scheme">
                ...
                <div>
                    ...
                    <button
                        onClick={useCallback(() => window.open("https://funcamp-funcamp.gitbook.io/espace-formateur/principes_pedagogiques"), [])}
